...
const messages = defineMessages({
  ...
  suggestions: { id: 'navigation_bar.suggestions', defaultMessage: 'Who to follow' },
...
export default class GettingStarted extends ImmutablePureComponent {
  ...
  render () {
    ...
    navItems.push(
      ...
      <ColumnLink key={i++} icon='user-plus' text={intl.formatMessage(messages.suggestions)} to='/suggestions' />
    );
          ...
          <div className='getting-started__footer'>
            ...
            <p>
              <FormattedMessage
                ...
                values={{ github: <span><a href='https://github.com/masto-donte-com-br/mastodon' rel='noopener' target='_blank'>masto-donte-com-br/mastodon</a> (v{version})</span> }}
              />
            </p>
          </div>
        </div>
